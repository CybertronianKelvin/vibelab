  ...
  return (
    <div
      ...
      className={`shrink-0 flex items-center justify-center group transition-colors z-10
        ${isH
          ? "w-1.5 cursor-col-resize hover:bg-amber-500/30 dark:bg-surface-600 bg-gray-200"
          : "h-1.5 cursor-row-resize hover:bg-amber-500/30 dark:bg-surface-600 bg-gray-200"
        }`}
    >
      <div
        className={`rounded-full bg-gray-500 group-hover:bg-amber-400 transition-colors

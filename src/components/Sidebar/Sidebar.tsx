    ...
    <aside className="w-56 flex flex-col border-r border-surface-600 bg-surface-800 shrink-0">
      ...
      <div className="p-2 border-b border-surface-600">
        <div className="flex gap-1">
          <input
            className="flex-1 bg-surface-700 border border-surface-500 rounded px-2 py-1 text-xs text-gray-200 placeholder-gray-500 outline-none focus:border-amber-500"
            placeholder="Name..."
            value={newName}
          ...
          <button
            ...
            className="px-2 py-1 bg-amber-500 hover:bg-amber-400 disabled:opacity-40 text-gray-900 text-xs font-bold rounded"
          >
            +
          </button>
        </div>
          ...
          snippets.map((s) => (
            ...
            >
              <div className="flex items-center gap-2 min-w-0">
                <span className="text-xs font-mono text-amber-400 shrink-0">{s.language.toUpperCase()}</span>
